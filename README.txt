...
Simply click https://demos.traudt.xyz/extensions/firefox/alliuminate_the_web/latest.xpi
in Firefox (and probably Tor Browser, see "Hard mode" section below) and allow
