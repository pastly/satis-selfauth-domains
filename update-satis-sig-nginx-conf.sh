...
# Variables
####################################
satis_sig_fname="/home/user/src/tor/data/satis_v3_service/satis_sig"
satis_sig_bad_time_fname="/home/user/src/tor/data/satis_v3_service/satis_sig_bad_time"
satis_sig_bad_fp_fname="/home/user/src/tor/data/satis_v3_service/satis_sig_bad_fp"
satis_sig_bad_domain_fname="/home/user/src/tor/data/satis_v3_service/satis_sig_bad_domain"
satis_sig_bad_sig_fname="/home/user/src/tor/data/satis_v3_service/satis_sig_bad_sig"
nginx_tmpl_fname="/usr/local/etc/nginx/nginx.conf.tmpl"
nginx_out_fname="/usr/local/etc/nginx/nginx.conf"
reload_nginx_command="service nginx reload"
